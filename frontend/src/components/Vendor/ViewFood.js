    ...
    useEffect(() => {
        async function abc() {
            if (user !== null && type=="Vendor") {
                ...
                axios
                    .post("http://localhost:4000/Vendor/getfood", getFood)
                    .then((response) => {
...
console.log(order.status);
            ...
            var x;
          axios
                .post("http://localhost:4000/Buyer/viewprofile", newEater)
                .then((response) => {
                    try {
                          x = response.data;
                 ...
                 axios
                        .post("http://localhost:4000/Buyer/increasemoney", newWallet)
                        .then((res) => {
                            try{
                             axios
                            .post("http://localhost:4000/Order/updatestatus", newUser)
                            .then((res) => {
   ...
   axios
                .post("http://localhost:4000/Order/ondeletefood", delFood)
                .then((response) => {
                    var x=response.data;
                    for(var i=0;i<x.length;i++)
                    {
                     ...
                     axios
                    .post("http://localhost:4000/Vendor/deletefood", delFood)
                    .then((response) => {
                        alert("Deleted\t");
                        // console.log("4");
                    });
    ...
    //   }
    // await    axios
    //         .post("http://localhost:4000/Vendor/getfooditemforedit", getFood)
    //         .then((response) => {
    //             // setFoodItems(response.data.fooditems);
