...
const MakeOrder = () => {
    ...
    async function abcd() {
        ...
        if (user_find !== null && type == "Buyer") {
            await axios
                .post("http://localhost:4000/Vendor/getfooditemforedit", { canteen: canteen, name: name })
                .then((response) => {
                ...
                axios
                .post("http://localhost:4000/Buyer/viewprofile",{name:user_find.email})
                .then((response) => {
    ...
    const finalOrder = () => {
        ...
        if (wallet >= price && foodItem.quantity != 0) {
            ...
            axios
                .post("http://localhost:4000/Buyer/increasemoney", newFood)
        }
