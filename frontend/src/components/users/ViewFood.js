...
const ViewFood = () => {
    ...
    async function abcd() {
        if (user_find !== null) {
            console.log("WHYYY")
            axios
                .post("http://localhost:4000/Buyer/getallfood")
                .then((response) => {
                    ...
                    for (var i = 0; i < shop_names.length; i++) {
                        axios
                            .post("http://localhost:4000/Vendor/viewprofilecanteen", { canteen: shop_names[i] })
                            .then((response) => {
                    ...
                    axios
                        .post("http://localhost:4000/Buyer/viewprofile", newUser)
                        .then((response) => {
                            // setFoodItems(response.data)
